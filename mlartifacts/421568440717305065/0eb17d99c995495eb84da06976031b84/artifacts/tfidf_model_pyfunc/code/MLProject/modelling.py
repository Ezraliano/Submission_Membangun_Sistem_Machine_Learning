...
def main():
    ...
    metrics = evaluate_recommendations(data, cosine_sim)
    ...
    input_example = pd.DataFrame({"text": ["example machine learning job"]})
    ...
    with mlflow.start_run():
        ...
        mlflow.pyfunc.log_model(
            ...
            signature=signature,
            code_path=[base_dir]  # <-- Ganti dari script_path ke folder
        )
